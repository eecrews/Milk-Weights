...
public class GUI extends Application {
  ...
  public void dataEditPage(Stage primaryStage) throws Exception {
    ...
    VBox pageFourRightVbox = new VBox(new Label("Edit an Entry\nLeave field blank if no change "),
        idEntry, yearEntry, monthEntry, dateEntry, new Button("Enter "));
  ...
  public void monthlyAnalysisPage(Stage primaryStage) throws Exception {
    ...
    enter.setOnAction(value -> {
      try {
        monthlyOutputPage(primaryStage, Integer.parseInt(yearEntry.getText()),
  ...
  public void monthlyOutputPage(Stage primaryStage, int yearInput, int monthInput) {
    ...
    /*
     * idLabel.setLayoutX((WINDOW_WIDTH/2)-175); idLabel.setLayoutY(WINDOW_HEIGHT/4);
     * yearLabel.setLayoutX((WINDOW_WIDTH/2)-175); yearLabel.setLayoutY(WINDOW_HEIGHT*(3/4));
     * enterButton.setLayoutX(WINDOW_WIDTH/2); enterButton.setLayoutY(WINDOW_HEIGHT-150);
     * year.setPrefSize(300,75); id.setPrefSize(300,75); id.setLayoutX((WINDOW_WIDTH/2)-50);
